...
func shouldCreateCopilotCommandFiles(projectDir string) bool { return shouldCreateCopilotRuleFiles(projectDir) }
...
func shouldCreateQDevRuleFiles(projectDir string) bool { return shouldCreateQDevCommandFiles(projectDir) }
